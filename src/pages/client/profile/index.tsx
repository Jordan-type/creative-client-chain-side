...
const ClientProfile = () => {
    ...
    const userData = {
        ...
        userImage: data?.user.image_url || "https://via.placeholder.com/150",
        userRating: 4.5, // Replace with actual rating if available
        userInbox: [], // Replace with actual inbox messages if available
        userReview: [], // Replace with actual reviews if available
        userPosts: [], // Replace with actual posts if available
        socialLinks: [], // Replace with actual social links if available
    }
